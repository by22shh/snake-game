...
public class Field {
    ...
    public List<Coord> findSnakeInitPlace() {
        ArrayList<Coord> initCoords = new ArrayList<>();
                        ...
                        for (int p = j - 2; p < j + 3; p++) {
                            ...
                            if (cells[k][p] != Cell.SNAKE) {
                                ...
                                if (count == 25) {
                                    ...
                                    initCoords.add(Coord.newBuilder().setY(i).setX(j + 1).build());
                                    initCoords.add(Coord.newBuilder().setY(i).setX(j).build());
