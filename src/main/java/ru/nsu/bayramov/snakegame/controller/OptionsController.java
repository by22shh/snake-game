...
public class OptionsController implements Initializable {
    ...
    private Image movedApplyButton = new Image("ru.nsu.bayramov.snakegame/buttons/apply_button/apply_2.png");
    private Image exitedApplyButton = new Image("ru.nsu.bayramov.snakegame/buttons/apply_button/apply_1.png");
