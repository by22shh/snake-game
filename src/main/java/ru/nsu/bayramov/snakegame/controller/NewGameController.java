...
public class NewGameController implements Initializable{
    ...
    private Image movedStartButton = new Image("ru.nsu.bayramov.snakegame/buttons/start_button/start_2.png");
    private Image exitedStartButton = new Image("ru.nsu.bayramov.snakegame/buttons/start_button/start_1.png");

    private Image movedBackButton = new Image("ru.nsu.bayramov.snakegame/buttons/back_button/back_2.png");
    private Image exitedBackButton = new Image("ru.nsu.bayramov.snakegame/buttons/back_button/back_1.png");
    ...
    public void startButtonPressed(MouseEvent event) throws IOException {
        try {
            ...
            Parent gameViewParent = FXMLLoader.load(getClass().getResource("/ru.nsu.bayramov.snakegame/fxml/game.fxml"));
