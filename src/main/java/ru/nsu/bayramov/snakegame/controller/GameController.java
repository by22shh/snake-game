...
import ru.nsu.bayramov.snakegame.model.Field;
import ru.nsu.bayramov.snakegame.model.SnakesProto;
import ru.nsu.bayramov.snakegame.model.SnakesProto.Direction;
...
import ru.nsu.bayramov.snakegame.model.events.EventListener;
...
public class GameController implements Initializable, EventListener {
    ...
    private final Image defaultCell = new Image("ru.nsu.bayramov.snakegame/game/cell.png");
    private final Image foodCell = new Image("ru.nsu.bayramov.snakegame/game/food_cell.png");
    private final Image snakeDefaultCell = new Image("ru.nsu.bayramov.snakegame/game/snake_default_cell.png");
    private final Image snakeHeadCell = new Image("ru.nsu.bayramov.snakegame/game/snake_head_cell.png");

    private final Image movedBackButton = new Image("ru.nsu.bayramov.snakegame/buttons/back_button/back_2.png");
    private final Image exitedBackButton = new Image("ru.nsu.bayramov.snakegame/buttons/back_button/back_1.png");
    ...
    public void backButtonPressed(MouseEvent event) throws IOException {
        ...
        Parent gameViewParent = FXMLLoader.load(getClass().getResource("/ru.nsu.bayramov.snakegame/fxml/menu.fxml"));
